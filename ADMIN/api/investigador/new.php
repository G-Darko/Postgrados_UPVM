        ...
        if (!($nameImg == "")) {
            ...
            if ($size <= 5000000) {
                ...
                if ($type == "image/png" || $type == "image/jpg" || $type == "image/jpeg" || $type == "image/gif") {
                    ...
                    $query = "INSERT INTO investigadores VALUES (NULL, '$name', '$lic', '$mae', '$doc', '$co', '$sam', '$subir', $niv, $div)";
            ...
            $query = "INSERT INTO investigadores VALUES (NULL, '$name', '$lic', '$mae', '$doc', '$co', '$sam', 'img/pre.png', $niv, $div)";
            $res = $con->query($query);
            if ($res) {
                $response->state = true;
            } else {
