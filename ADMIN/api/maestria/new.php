        ...
        if (!($nameImg == "")) {
            ...
            if ($size <= 5000000) {
                ...
                if ($type == "image/png" || $type == "image/jpg" || $type == "image/jpeg" || $type == "image/gif") {
                    ...
                    $query = "INSERT INTO maestria VALUES (NULL, '$name', '$ob', '$pi', '$req', '$pe', '$campo', '$compe', '$subir', $tipo, $div, '$op')";
            ...
            $queryD = "INSERT INTO maestria VALUES (NULL, '$name', '$ob', '$pi', '$req', '$pe', '$campo', '$compe', 'img/pre.png', $tipo, $div, '$op')";
