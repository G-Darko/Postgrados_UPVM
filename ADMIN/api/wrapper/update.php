        ...
        if (!($nameImg == "")) {
            ...
            if ($size <= 5000000) {
                ...
                if ($type == "image/png" || $type == "image/jpg" || $type == "image/jpeg" || $type == "image/gif") {
                    ...
                    $query = "UPDATE wrapper SET img = '$subir', redir = '$re', titulo = '$ti', descripcion = '$des' WHERE id_wra = $id";
            ...
            $query = "UPDATE wrapper SET redir = '$re', titulo = '$ti', descripcion = '$des' WHERE id_wra = $id";
            $res = $con->query($query);
            if ($res) {
                $response->state = true;
            } else {
