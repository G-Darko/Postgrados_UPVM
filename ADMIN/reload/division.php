...
$queryPag = "SELECT COUNT(*) as total FROM division";
...
$query = "SELECT * FROM division LIMIT $desde, $xPage";
$res = $con->query($query);
?>
...
<section class="main">
        ...
        <div class="table">
            ...
            ?>
                <div class='row'>
                    ...
                    <div class="btns col">
                        <button title="Editar" onclick="edit(<?php echo $row['id_div']; ?>)"><box-icon name='edit' size='md'></box-icon></button>
                        <button title="Eliminar" class='delete' onclick="deleteI(<?php echo $row['id_div']; ?>)"><box-icon name='trash' size='md'></box-icon></button>
                    </div>
                </div>
    ...
    paginador('reload/division.php', $page, $tPags); 
    ?>
...
<div id="mNew" class="modal">
    <div class="body">
        <header>
            <h2><box-icon name='plus' size='md'></box-icon> Nueva división</h1>
...
<div id="mEdit" class="modal">
    <div class="body">
        <header>
            <h2><box-icon name='edit' size='md'></box-icon> Editar división</h1>
                <button class='close' onclick="modal(this.parentNode.parentNode.parentNode.getAttribute('id'), false)"><box-icon name='x' size='md'></box-icon></button>
        </header>
        <div class="form">
            <div class="inputBox">
