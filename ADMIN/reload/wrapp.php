...
$queryPag = "SELECT COUNT(*) as total FROM wrapper";
...
$query = "SELECT * FROM wrapper LIMIT $desde, $xPage";
$res = $con->query($query);
?>
...
<section class="main">
        ...
        <div class="table">
            ...
            ?>
                <div class='row'>
                    ...
                    <div class="btns col">
                        <button title="Editar" onclick="edit(<?php echo $row['id_wra']; ?>, quillsE())"><box-icon name='edit' size='md'></box-icon></button>
                        <button title="Eliminar" class='delete' onclick="deleteI(<?php echo $row['id_wra']; ?>)"><box-icon name='trash' size='md'></box-icon></button>
                    </div>
                </div>
            <?php
            }
    ...
    paginador('reload/wrapp.php', $page, $tPags);
    ?>
</section>
...
<div id="mNew" class="modal">
    <div class="body">
        <header>
            <h2><box-icon name='plus' size='md'></box-icon> Nueva informacion</h1>
        ...
        <div class="form">
            ...
            <div class="inputBox">
                <input type="text" required id='n-ti' autocomplete="off">
                <span>Titulo*</span>
                <i></i>
            </div>

            <span class="nameQuill">Descripcion*</span>
            <div id="n-des" class='quill'>
            </div>
...
<div id="mEdit" class="modal">
    <div class="body">
        <header>
            <h2><box-icon name='edit' size='md'></box-icon> Editar informacion</h1>
                <button class='close' onclick="modal(this.parentNode.parentNode.parentNode.getAttribute('id'), false)"><box-icon name='x' size='md'></box-icon></button>
        </header>
        <div class="form">

            <div class="inputBox">
                <input type="text" required id='e-ti' autocomplete="off">
                <span>Titulo*</span>
                <i></i>
            </div>

            <span class="nameQuill">Descripcion*</span>
            <div id="e-des" class='quill'>
            </div>
