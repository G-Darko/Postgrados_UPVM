...
$queryPag = "SELECT COUNT(*) as total FROM tipo";
...
$query = "SELECT * FROM tipo LIMIT $desde, $xPage";
$res = $con->query($query);
?>
...
<section class="main">
        ...
        <div class="table">
            ...
            ?>
                <div class='row'>
                    ...
                    <div class="btns col">
                        <button title="Editar" onclick="edit(<?php echo $row['id_tipo']; ?>)"><box-icon name='edit' size='md'></box-icon></button>
                        <button title="Eliminar" class='delete' onclick="deleteI(<?php echo $row['id_tipo']; ?>)"><box-icon name='trash' size='md'></box-icon></button>
                    </div>
                </div>
    ...
    paginador('reload/tipo.php', $page, $tPags); 
    ?>
...
<div id="mNew" class="modal">
    <div class="body">
        <header>
            <h2><box-icon name='plus' size='md'></box-icon> Nuevo tipo</h1>
...
<div id="mEdit" class="modal">
    <div class="body">
        <header>
            <h2><box-icon name='edit' size='md'></box-icon> Editar tipo</h1>
                <button class='close' onclick="modal(this.parentNode.parentNode.parentNode.getAttribute('id'), false)"><box-icon name='x' size='md'></box-icon></button>
        </header>
        <div class="form">
            <div class="inputBox">
